...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl>
                <dt><?=$v->id?>.<?=$v->name?> <?=$v->cmbProvince?> <?=$v->cmbCity?> <?=$v->cmbArea?> <?=$v->address?> <?=$v->tel?> </dt>
                <dd>
                    <a href="<?= \yii\helpers\Url::to(['address/edit','id'=>$v->id])?>">修改</a>
                    <a href="#" id="<?=$v->id?>" onclick="delAddress(<?=$v->id?>)">删除</a>
                    <a href="<?= \yii\helpers\Url::to(['address/status','id'=>$v->id])?>">设为默认地址</a>
                </dd>
            </dl>
            <?php endforeach;?>
        </div>
            ...
            <form action="" method="post" id="address_form" name="address_form">
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" value="<?=isset($address->name)?$address->name:""?>" name="name" class="txt" />
                    </li>
                    <li>
                        ...
                        <script type="text/javascript">
                            ...
                            '<?=isset($address->cmbProvince)?$address->cmbProvince:""?>','<?=isset($address->cmbCity)?$address->cmbCity:""?>','<?=isset($address->cmbArea)?$address->cmbArea:""?>');
                        </script>
                    </li>
                    <li>
                        <label for=""><span>*</span>详细地址：</label>
                        <input type="text" value="<?=isset($address->address)?$address->address:""?>" name="address" class="txt address"  />
                    </li>
                    <li>
                        <label for=""><span>*</span>手机号码：</label>
                        <input type="text" value="<?=isset($address->tel)?$address->tel:""?>"  name="tel" class="txt" />
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
//              $("#"+id+"").parent().parent().remove();
    ...
    $("#address_form").validate({
        rules: {
            name:{
                required:true,
                message:'用户名不能为空',
                //remote : '/user/validateusername',//ajax后台验证
                // /user/validateusername?username=xxxx
                minlength: 2
            } ,
            ...
            tel:{
                required:true,
                //remote : '/user/validatecode',//ajax后台验证
                //minlength: 2
            } ,
        },
        errorElement:'span'
    ...
    $.extend($.validator.messages, {
        ...
        rangelength: $.validator.format("请输入长度在 {0} 到 {1} 之间的数字"),
