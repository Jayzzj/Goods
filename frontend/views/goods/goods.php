    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl cat1">
            ...
            <div class="cat_bd none">
                <?php foreach ($goodsCategorys as $k =>$goodsCategory):?>
                <div class="cat<?=$k?'':' item1'?>">
                    <h3><a href="<?= \yii\helpers\Url::to(['index/list','id'=>$goodsCategory->id])?>"><?=$goodsCategory->name?></a> <b></b></h3>
                    <div class="cat_detail none">
                     <?php foreach ($goodsCategory->goodscategory as $j=>$children):?>
                        <dl class="<?=$j?'':'dl_1st'?>">
                            <dt><a href="<?= \yii\helpers\Url::to(['index/list','id'=>$children->id])?>"><?= $children->name?></a></dt>
                            <dd>
                                <?php foreach ($children->goodscategory as $child):?>
                                <a href="<?=\yii\helpers\Url::to(['index/list','id'=>$child->id])?>"><?= $child->name?></a>
                                <?php endforeach;?>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
               ...
               <?php foreach ($model->goodsgallery as $k=>$v):?>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <?php  if ($k==0){?>
                             <?php echo '<li class="cur">'.'<a class="zoomThumbActive"'?>
                            <?php }else{
                                echo "<li>"."<a";;
                            }?>
...
<!--                        <img src="/images/desc9.jpg" alt="" />-->
                        <?php if (isset($model->intro->content)){
                            echo $model->intro->content;
                        }?>
                    </div>
                </div>
                <!-- 商品介绍 end -->
