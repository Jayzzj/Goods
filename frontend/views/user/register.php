        ...
        <div class="login_form fl">
            <form action="" method="post">
                ...
                <ul>
                    ...
                    <li>
                        <label for="">验证码：</label>
                        <input type="text"  class="txt" value="" placeholder="请输入短信验证码" name="captcha"  id="captcha"/>
...
<!--                    </li>-->
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input  id="submit" type="submit" value="" class="login_btn" />
                    </li>
                </ul>
            </form>
...
//       //发送ajax
//       $.getJSON('http://www.yiishop.com/user/checksms',{tel:tel,code:code},function (data) {
//           console.log(data);
//           if (data ===1){
//               console.log('验证成功');
//           }else {
