            ...
            <div class="cat_bd none">
              ...
              <?php foreach ($goodsCategorys as $k=> $goodscategory):?>
                <div class="cat<?= $k?'':' item1'?>">
                    ...
                    <h3><a href="<?= \yii\helpers\Url::to(['list','id'=>$goodscategory->id])?>">
                            <?= $goodscategory->name?></a> <b></b></h3>
                    <div class="cat_detail none">
                      <?php foreach ($goodscategory->goodscategory as $j=>$childs):?>
                        <dl class="dl<?=$j?'':'_1st'?>">

                            <dt>
                                <a href="<?= \yii\helpers\Url::to(['list','id'=>$childs->id])?>"><?php $childs->name?></a></dt>
                            <dd>
                                <?php foreach ($childs->goodscategory as $child):?>
                                <a href="<?= \yii\helpers\Url::to(['list','id'=>$child->id])?>"><?= $child->name?></a>
                                <?php endforeach;?>
                            </dd>
                        </dl>
